...
When splitting the stream inbound to BOOIN between RWY 27 and RWY 34, controllers should reroute aircraft for RWY 27 via the **BOYSE STAR**. Aircraft for RWY 34 should be cleared the **BOOIN A STAR**. This provides lateral separation assurance in the TMA.
