...
!!! phraseology
    *UTY7242 is departing Runway 15 on the CS (RADAR) SID in VMC*  
    <span class="hotline">**CS ADC** -> **CS1**</span>: "Next, UTY7242, runway 15"  
    <span class="hotline">**CS1** -> **CS ADC**</span>: "UTY7424, runway 15, heading 350, unrestricted"  
    <span class="hotline">**CS ADC** -> **CS1**</span>: "Heading 350, UTY7242"
...
!!! phraseology
    *JCI is tracking inbound from the north at `A050` and has reported visual.*  
    <span class="hotline">**CS1** -> **CS ADC**</span>: "Via right base, JCI, will be assigned A020 visual"  
    <span class="hotline">**CS ADC** -> **CS1**</span>: "A020 visual, JCI" 
...
!!! phraseology
    ...
    <span class="hotline">**KEN** -> **CS2**</span>: "JST789, concur F160"  
