...
- Aircraft inbound to YBBN from the north may be issued the **Mike** STAR to reduce track miles. This should only be assigned during 01RA01LD segregated operations.
