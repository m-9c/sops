...
- Aircraft to YSWS via UNTAV may be assigned the **UNTAV B** STAR in lieu of the **UNTAV A** STAR, for track shortening or separation, **when the [R481 COLO restricted area](#r481-colo) is not activated**.
